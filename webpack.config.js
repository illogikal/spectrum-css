    ...
    module: {
        rules: [{
            ...
            use: [{
                ...
                options: {
                    outputPath: () => { // (url, resourcePath, context) => {
                        return `assets/images/${isDev ? '[name][ext]' : '[contenthash][ext]'}`; // was: ${url.replace(/_\//g, '')}`;
                    },
                },
            }]
        }, {
            ...
            use: [{
                ...
                options: {
                    outputPath: () => { // (url, resourcePath, context) => {
                        return `assets/fonts/${isDev ? '[name][ext]' : '[contenthash][ext]'}`; // was: ${url.replace(/_\//g, '')}`;
                    },
                },
            }]
        }, {
            ...
            use: [{
                // note: the babel config exists at /.babelrc.json
                loader: "babel-loader",
            }],
        }, {
          test: /\.js$/,
